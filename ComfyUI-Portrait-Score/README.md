...
Metric	Description	Source Node
Sharpness Score	Focus & edge clarity	Sharpness / Focus Score
Clipping Score	Highlight / shadow clipping	Clipping Analysis
Noise Score	Residual visual noise	Noise Estimation
Color Cast Score	Color balance deviation	Color Cast Detector
Contrast Score	Tonal separation	Contrast Analysis
...
Copy or clone this repository into your ComfyUI custom nodes directory:
